<template>
    ...
    <modal class="p-0" ref="modal" :size="'xl'" @on-hide="reset"
        ...
        <form @submit.prevent="saveLetter">
            ...
            <div class="mb-3">
                <label class="form-label">Aparat Penandatangan Desa</label>
                <search-input placeholder="Cari Aparat Desa ..." ref="search_input_penandatangan_desa"
            ...
            <template #penandatangan>
                <form method="POST" @submit.prevent="savePenandatanganKecamatan">
                    <div class="mb-3" v-if="letter.penandatangan_kecamatan != null">
                        <label class="form-label">Aparat Penandatangan Yang Tersimpan</label>
