            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-2">Buat akun admin 🚀</h4>
                        {{-- <p class="mb-4">Make your app management easy and fun!</p> --}}
                        <form id="formAuthentication" class="mb-3" action="{{ route('register.action') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label for="username" class="form-label">Nama</label>
                                <input type="text" required value="{{old('name')}}" class="form-control" id="name" name="name"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" required value="{{old('email')}}" class="form-control" id="email" name="email"
                            ...
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" required value="{{old('password')}}" id="password" class="form-control" name="password"
                                        placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                            ...
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" required value="{{old('secret_key')}}" id="secret_key" class="form-control" name="secret_key"
                                        placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                        aria-describedby="secret_key" />
                                    <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                                </div>
                                @if ($errors->has('secret_key'))
                                    <ul class="text-danger m-0">
                                        @foreach ($errors->get('secret_key') as $error)
                                            <li>{{ $error }}</li>
                                        @endforeach
                                    </ul>
                                @endif
